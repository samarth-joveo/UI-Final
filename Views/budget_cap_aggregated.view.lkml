...
client_budget as (select sum(budget_value) client_budget from idp.modelled.campaign_management_clients where {% condition client_name %} name {% endcondition %}),
...
select current_date,* from client_budget join campaign_budget join jg_budget_outer;;}
